...
full_batters_2014 <- batters_2014_dta %>% 
  left_join(batters_2013_dta, by = 'playerid', suffix = c("_C", "_P1"))

colnames(batters_2012_dta) <- paste(colnames(batters_2012_dta), "P2", sep = "_")

full_batters_2014 <- full_batters_2014 %>%
  left_join(batters_2012_dta, by = c('playerid' = 'playerid_P2')) %>%
  select(-c(First_P1, First_P2, Last_P1, Last_P2))

## 2015 batter data with past 2 years performance
full_batters_2015 <- batters_2015_dta %>% 
  left_join(batters_2014_dta, by = 'playerid', suffix = c("_C", "_P1"))

colnames(batters_2013_dta) <- paste(colnames(batters_2013_dta), "P2", sep = "_")

full_batters_2015 <- full_batters_2015 %>%
  left_join(batters_2013_dta, by = c('playerid' = 'playerid_P2')) %>%
  select(-c(First_P1, First_P2, Last_P1, Last_P2))

## 2016 batter data with past 2 years performance
full_batters_2016 <- batters_2016_dta %>% 
  left_join(batters_2015_dta, by = 'playerid', suffix = c("_C", "_P1"))

colnames(batters_2014_dta) <- paste(colnames(batters_2014_dta), "P2", sep = "_")

full_batters_2016 <- full_batters_2016 %>%
  left_join(batters_2014_dta, by = c('playerid' = 'playerid_P2')) %>%
  select(-c(First_P1, First_P2, Last_P1, Last_P2))

## 2017 batter data with past 2 years performance
full_batters_2017 <- batters_2017_dta %>% 
  left_join(batters_2016_dta, by = 'playerid', suffix = c("_C", "_P1"))

colnames(batters_2015_dta) <- paste(colnames(batters_2015_dta), "P2", sep = "_")

full_batters_2017 <- full_batters_2017 %>%
  left_join(batters_2015_dta, by = c('playerid' = 'playerid_P2')) %>%
  select(-c(First_P1, First_P2, Last_P1, Last_P2))

## 2018 batter data with past 2 years performance
full_batters_2018 <- batters_2018_dta %>% 
  left_join(batters_2017_dta, by = 'playerid', suffix = c("_C", "_P1"))

colnames(batters_2016_dta) <- paste(colnames(batters_2016_dta), "P2", sep = "_")

full_batters_2018 <- full_batters_2018 %>%
  left_join(batters_2016_dta, by = c('playerid' = 'playerid_P2')) %>%
  select(-c(First_P1, First_P2, Last_P1, Last_P2))

## 2019 batter data with past 2 years performance
full_batters_2019 <- batters_2019_dta %>% 
  left_join(batters_2018_dta, by = 'playerid', suffix = c("_C", "_P1"))

colnames(batters_2017_dta) <- paste(colnames(batters_2017_dta), "P2", sep = "_")

full_batters_2019 <- full_batters_2019 %>%
  left_join(batters_2017_dta, by = c('playerid' = 'playerid_P2')) %>%
  select(-c(First_P1, First_P2, Last_P1, Last_P2))
